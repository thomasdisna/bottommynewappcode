    ...
    showModalBottomSheet(backgroundColor: Color(0xFF1E2026),
        ...
        builder: (BuildContext bc) {
          ...
          _qualityValues.forEach((elem, value) => (children.add(new ListTile(
              title: new Text(" ${elem.toString()} fps",style: f15w,),
              onTap: () => {
        ...
        ? Stack(
            children: <Widget>[
              ...
              Center(
                child: IconButton(
                    ...
                    icon: _controller.value.isPlaying
                        ? Icon(Icons.pause, size: 60.0,color: Color(0xFF1E2026),)
                        : Icon(Icons.play_arrow, size: 60.0,color: Color(0xFF1E2026),),
                    onPressed: () {
                      setState(() {
              ...
              Container(
                ...
                child: IconButton(
                    alignment: AlignmentDirectional.center,
                    icon: Icon(Icons.fullscreen, size: 30.0,color: Color(0xFF1E2026),),
                    onPressed: () {
                      setState(() {
                        _controller.pause();
                        SystemChrome.setPreferredOrientations([
              ...
              Container(
                ...
                child: IconButton(
                    icon: Icon(Icons.settings, size: 26.0,color: Color(0xFF1E2026),),
                    onPressed: () {
              ...
              Container(
                ...
                child: VideoProgressIndicator(
                  ...
                  colors: VideoProgressColors(
                    playedColor: Color(0xFF48c0d8),
                    backgroundColor: Color(0xFF1E2026),
                    bufferedColor: Color(0xFFffd55e),
                  ),
