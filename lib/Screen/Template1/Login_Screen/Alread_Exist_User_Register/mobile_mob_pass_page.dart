...
class AlreadyExistMobilePasswordPage extends StatefulWidget {
  AlreadyExistMobilePasswordPage(
      {Key key, this.name, this.surname, this.email, this.dob, this.gender,this.mobile,this.pass,this.loc,this.lat,this.long,this.state,this.district,this.lastname})
      : super(key: key);
  String name, surname, email, dob, gender,mobile,pass,loc,lat,long,state,district,lastname;

  @override
  _AlreadyExistMobilePasswordPageState createState() => _AlreadyExistMobilePasswordPageState();
}

class _AlreadyExistMobilePasswordPageState extends StateMVC<AlreadyExistMobilePasswordPage> {
  ...
  _AlreadyExistMobilePasswordPageState() : super(TimelineWallController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    _confirmpassword.text=widget.pass;
    _location.text=widget.loc;
    // _lastName.text = widget.lastname;
    location_lat.text=widget.lat;
    location_long.text=widget.long;
    selected_State=widget.state;
    selected_district=widget.district;
    });
    print("mobbbbb111 add "+_location.text);
    print("mobbbbb1111 lat & long "+location_lat.text+" & "+location_long.text);
  }
  ...
  submit() {
    ...
    if (!form.validate()) {
      ...
      _con.register(context,_name.text, _surname.text, _email.text, _dob.text,
          _gender.text, _mobile.text, _password.text,
          location_lat.text,location_long.text,fire_token,selected_State,selected_district, _location.text,widget.lastname);
    }
  }
                                ...
                                child: Theme(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      autocorrect: false,
                                      autofocus: false,
                                      decoration: InputDecoration(errorText: "mobile number already exist !!!",
