...
class ExistEmailSignUp extends StatefulWidget {
  ExistEmailSignUp({Key key,this.name,this.dob,this.email,this.gender,this.surname,this.lastname}) : super(key: key);
  String name, surname, email, dob, gender,lastname;
  @override
  _ExistEmailSignUpState createState() => _ExistEmailSignUpState();
}

class _ExistEmailSignUpState extends StateMVC<ExistEmailSignUp> {
  TimelineWallController _con;
  bool autovalidate = false;
  Validations validations = new Validations();

  _ExistEmailSignUpState() : super(TimelineWallController()) {
    _con = controller;
  }
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                        border: InputBorder.none,
                                        contentPadding: EdgeInsets.all(0.0),
                                        filled: true,errorText: "email already exist !!!",
                                        fillColor: Colors.transparent,
                                        labelText: 'Email',
                                        hintStyle: TextStyle(color: Colors.white),
                                        labelStyle: TextStyle(
