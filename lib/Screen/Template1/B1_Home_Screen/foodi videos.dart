...
class FoodieTimelineWallVideos extends StatefulWidget {

  FoodieTimelineWallVideos({this.idddd,this.video_id});

  int idddd;
  String video_id;

  @override
  _FoodieTimelineWallVideosState createState() => _FoodieTimelineWallVideosState();
}

class _FoodieTimelineWallVideosState extends StateMVC<FoodieTimelineWallVideos> {

  TimelineWallController _con;

  _FoodieTimelineWallVideosState() : super(TimelineWallController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    _con.getFullVideosList(widget.idddd);
              ...
              child: Column(
                ...
                children: [
                  ...
                  /* && _sharedshowml ==
                      ...
                      : Container(height: 0),*/
                  /* mainVideo["shared_post_id"] ==null ? */ SizedBox(height: 17,) /*: Container()*/,
                  /* mainVideo["shared_post_id"] ==null ? */ Container(height: h/2.7,
                    child: YoutubePlayer(
      controller: _utubecontroller,
      liveUIColor: Colors.amber,
    ),
                  ), /*: Container()*/
                  /*mainVideo["shared_post_id"] ==null ? */SizedBox(height: 15,) /*: Container()*/,
                  Padding(
                    padding: const EdgeInsets.only(
                        left: 7.0,
                        right: 7,
                    ...
                    return  _con.fullVideosList[ind]["id"]==widget.idddd ? Container() :InkWell(
                      onTap: (){
                        Navigator.pushReplacement(context, MaterialPageRoute(
                            builder: (context) => FoodieTimelineWallVideos(idddd:  _con.fullVideosList[ind]["id"],video_id: _con
                                .fullVideosList[
                            ind][
                            "youtube_video_id"]
                                .toString(),)
