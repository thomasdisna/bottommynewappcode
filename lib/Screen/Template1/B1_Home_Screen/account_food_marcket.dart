...
import 'package:Butomy/Screen/Template1/B1_Home_Screen/Each_Item_Detail_view_page.dart';import 'package:Butomy/Screen/Template1/B1_Home_Screen/food_bank_detail_page.dart';
...
class AccountFoodMarcket extends StatefulWidget {

  ScrollController marketcontro;
  String pageid;
  AccountFoodMarcket({this.marketcontro,this.pageid});

  @override
  _AccountFoodMarcketState createState() => _AccountFoodMarcketState();
}

class _AccountFoodMarcketState extends StateMVC<AccountFoodMarcket>
    with SingleTickerProviderStateMixin {

  HomeKitchenRegistration _con;

  _AccountFoodMarcketState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  Future<void> _getData() async {
    setState(() {
      _con.FoodiBankAccount("6",widget.pageid.toString());
    });
    await Future.delayed(Duration(milliseconds: 1000));
                      ...
                      onTap: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(
                            builder: (context)=>FoodiMarketDetailPage(
                              price: _con.AccFoodBank[indexxx]["kitchen_item_amount"].toString(),
                              itemname: _con.AccFoodBank[indexxx]["kitchen_item_name"].toString(),
                              product_id: _con.AccFoodBank[indexxx]["kitchen_item_id"].toString(),)
                        ));
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Text(_con
                                              .AccFoodBank[indexxx]["kitchen_item_name"].toString().length>21 ? _con
                                              .AccFoodBank[indexxx]["kitchen_item_name"].toString().substring(0,21)+" ..."
                                              : _con
                                  ...
                                  Container(alignment: Alignment.centerLeft,
                                    child: Padding(
                                      ...
                                      child: Text("Price : "+_con
                                          .AccFoodBank[indexxx]["kitchen_item_amount"].toString(),style: f14bB,)
                                    ),
                                  ),
                                ],
                              ),
