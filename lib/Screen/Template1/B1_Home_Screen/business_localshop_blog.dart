...
class BusinessLocalShopBlog extends StatefulWidget {

  BusinessLocalShopBlog({this.contro,this.timid});
  ScrollController contro;
  String timid;
  @override
  _BusinessLocalShopBlogState createState() =>
      _BusinessLocalShopBlogState();
}

class _BusinessLocalShopBlogState extends StateMVC<BusinessLocalShopBlog> {

  HomeKitchenRegistration _con;

  _BusinessLocalShopBlogState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
