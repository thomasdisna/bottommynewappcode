...
import 'business_localshop_bottombar.dart';
...
class BusinessLocalShopAddProductPage extends StatefulWidget {

  BusinessLocalShopAddProductPage({this.timid,this.pagid,this.memberdate});
  String pagid,timid,memberdate;

  @override
  _BusinessLocalShopAddProductPageState createState() => _BusinessLocalShopAddProductPageState();
}

class _BusinessLocalShopAddProductPageState extends StateMVC<BusinessLocalShopAddProductPage> {
  File imageFile;
  int servicecharge=3;
  int product_cost=0;
  var distance_value;
  ...
  _BusinessLocalShopAddProductPageState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  _SubCatimagUpload() {
    _con.HomekitchenAddSubCategory(
        ...
        categrynewimg.toString(),context,widget.pagid,widget.timid,"2"
    );
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) =>
                bottomNavBarLocalShop(memberdate: widget.memberdate,pagid: widget.pagid,timid: widget.timid,currentIndex: 3,upld: false,)));
  ...
  _imagUpload() {
    ...
    _con.LocAddItem(context,userid.toString(),IMAGELIST.join(",").toString(),subCatg,"image",_displayName.text,_price.text,subCatg,hot_deal?"1":"0",switchControlBuyPre?"1":0,"2",
              ...
              Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButton(
                      ...
                      items: _con.StoreCategories.map((item) {
