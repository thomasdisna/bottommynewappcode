import 'package:Butomy/Screen/Template1/B1_Home_Screen/foodi_reset_pin_confirm_screeen.dart';
...
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_homekitchen_kitchen_wall.dart';
...
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_homekitchen_menu.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_homekitchen_reviews.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_homekitchen_blog.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_homekitchen_videos.dart';
...
DateTime _date;
var Month_year;
class BusinessHomeKitchenTimeline extends StatefulWidget {
  BusinessHomeKitchenTimeline({Key key,this.memberdate,this.timid,this.pagid,this.upld}) : super(key: key);

  String pagid,timid,memberdate;
  bool upld;

  @override
  _BusinessHomeKitchenTimelineState createState() =>
      _BusinessHomeKitchenTimelineState();
}

class _BusinessHomeKitchenTimelineState extends StateMVC<BusinessHomeKitchenTimeline> with SingleTickerProviderStateMixin {

  HomeKitchenRegistration _con;
  _BusinessHomeKitchenTimelineState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
                        ...
                        image: DecorationImage(
                            image:   CachedNetworkImageProvider(
                                _con.homeKitchenProfileData["data"][0]["profile_image"]!=null && _con.homeKitchenProfileData["data"][0]["profile_image"]!=""
                                    ...
                                    _con.homeKitchenProfileData["data"][0]["profile_image"]+"?alt=media" : "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                    "icu.png" +"?alt=media"
                            ) ,
                            fit: BoxFit.cover),
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => BusinessAboutInfo(typ: "1",pagid: widget.pagid,timid: widget.timid,
                                    )));
                          },
                          child: Text(
                              "About Info",
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(
                        builder: (context)=>BusinessPosts(id: widget.timid,type: "1",
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) =>BusinessFollowingPage(pageId: widget.pagid.toString(),type: "1",)));
                    },
                    child: Row(
                      children: <Widget>[
                        Text(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: TabBarView(
                  controller: _tabContoller,
                  children: <Widget>[
                    BusinessHomekitchenKitchenwall(pagid: widget.pagid,timid: widget.timid,contro: _timControoooo,contheight:  _fromTop!=0 ? MediaQuery.of(context).size.height - 196 : MediaQuery.of(context).size.height - 519,),
                    BusinessHomeKitchenMenu(pagid: widget.pagid,timid: widget.timid,controo: _timControoooo,),
                    BusinessHomeKitchenVideos(contro: _timControoooo,),
                    BusinessHomeKitchenReviews(controo: _timControoooo,),
                    BusinessHomeKitchenBlog(contro: _timControoooo,timid: widget.timid,),
                  ],
                ),
              )
            ],
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Column(
              children: <Widget>[
                kituploadgg==true?  ImageUploadProgress() : Container(),
                Container(
                  height: 150,
                  width: MediaQuery.of(context).size.width,
                  child: Image.asset("assets/Template1/image/Foodie/kitchen_back.jpg",fit: BoxFit.cover,),
                ),
                _kitchenDetails,
                _shareBagde,
                _follow,
              ...
              CustomListTile2(
                  ...
                  'Reset Pin',
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => resetBusinessConfirmScreen(
                              memberdate: widget.memberdate,name: _con.homeKitchenProfileData["data"][0]["name"],
                              pagid: widget.pagid,timid: widget.timid,typ: "1",upld: false,pin:  _con.homeKitchenProfileData["data"][0]["business_pin"].toString(),
                            )))
                  }),
              CustomListTile(
                  Icons.info_outline,
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => BusinessHomeKitchenOrderPage(memberdate: widget.memberdate,timid: widget.timid,pagid: widget.pagid,)
                  ));
                },
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
