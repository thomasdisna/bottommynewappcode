...
class DrawerHomekitSettings extends StatefulWidget {
  @override
  _DrawerHomekitSettingsState createState() => _DrawerHomekitSettingsState();
}

class _DrawerHomekitSettingsState extends State<DrawerHomekitSettings> {
  @override
