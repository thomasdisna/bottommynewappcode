...
class bottomNavBarHomeKitchen extends StatefulWidget {
  bottomNavBarHomeKitchen(
...
class _bottomNavBarState extends State<bottomNavBarHomeKitchen> {
  ...
  Widget callPage(int current) {
    switch (current) {
      case 0:
        return new BusinessHomeKitchenTimeline(
      ...
      case 1:
        ...
        break;
      case 2:
        return new HomeKitNewEntryForm(
          memberdate: widget.memberdate,
          timid: widget.timid,
          pagid: widget.pagid,
        );
        break;
      case 3:
        return new BusinessHomeKitchenProductListPage(
          pageid: widget.pagid,
          timeid: widget.timid,
          memberdate: widget.memberdate,
        );
