...
class FoodiMarketForm extends StatefulWidget {
  @override
  _FoodiMarketFormState createState() => _FoodiMarketFormState();
}
...
class _FoodiMarketFormState extends StateMVC<FoodiMarketForm> {

  TimelineWallController _con;

  _FoodiMarketFormState() : super(TimelineWallController()) {
    _con = controller;
  }
  ...
  _imagUpload() {
    _con.addFoodiMarketProduct(context,
        IMAGELISTS.join(",").toString(),_desc.text,_title.text,crntindex==6 ? _other.text : crntindex.toString(),
        _loc.text,loc_lat.toString(),loc_long.toString(),days_value.toString(),
       _price.text,cat_value_id.toString(),_tags.text,item_listing.toString());
    // _uploadTask=null;
  ...
  void initState() {
    ...
    setState(() {
     ...
     // userLocation.latitude, userLocation.longitude
      loc_lat = userLocation.latitude;
      loc_long = userLocation.longitude;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 5,
        title: Text("Add Foodie Market Listing",style: TextStyle(color: Colors.white),),
      ),
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton(
                      ...
                      items:  _con.MarketKitchenCategories.map((item) {
                        return DropdownMenuItem(
                          onTap: (){
                            setState(() {
                              cat_value_id=item["id"].toString();
                            });
                          },
                          value: item["name"],
              ...
              Container(
                  ...
                  child: GoogleMap(
                    ...
                    initialCameraPosition: CameraPosition(
                      target: LatLng(loc_lat, loc_long),
                      zoom: 10.4746,
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (newValue) {
                      setState(() {
                        item_listing = newValue;
                      });
                    },
                    items: listingItem.map((item) {
                      return DropdownMenuItem(
                        value: item,
                        child: Text(item),
                      );
