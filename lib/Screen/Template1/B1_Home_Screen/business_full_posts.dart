...
class BusinessPosts extends StatefulWidget {
  ...
  BusinessPosts({Key key,this.id,this.type,this.timid,this.pagid,this.memberdate}) : super(key: key);
  String id,pagid, timid, memberdate;
  String type;


  @override
  _BusinessPostsState createState() => _BusinessPostsState();
}

class _BusinessPostsState extends StateMVC<BusinessPosts> {
  ...
  void initState() {
    ...
    _con.getPersonalPosts(widget.id.toString(),userid.toString());
    scrollController = ScrollController();
  ...
  _BusinessPostsState() : super(TimelineWallController()) {
    _con = controller;
  }
                                      ...
                                      children: <Widget>[
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                image: DecorationImage(
                                                    ...
                                                    ["picture"]!=null && _con.AccountPostData[index]
                                                    ["picture"]!=""  ?  CachedNetworkImageProvider(
                                                        "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+_con.AccountPostData[index]
                                                    ...
                                                    fit: BoxFit.cover),
                                                border: Border.all(color:  _con.AccountPostData[index]
                                                ["picture"]==null || _con.AccountPostData[index]
                                                ["picture"]=="" ? Color(0xFF48c0d8) : Colors.transparent),
                                        ...
                                        Container(
                                          child: GestureDetector(
                                            onTap: () {
                                              widget.type=="1" ? Navigator.push(context, MaterialPageRoute(
                                                  builder: (context)=>KitchenProf(currentindex: 1,memberdate:widget.memberdate,
                                                    pagid:widget.pagid,
                                                    timid:widget.timid,))) : widget.type=="2" ?
                                              Navigator.push(context, MaterialPageRoute(
                                                  builder: (context)=>StoreProf(currentindex: 1,memberdate:widget.memberdate,
                                                    pagid:widget.pagid,
                                                    timid:widget.timid,))) : widget.type=="3" ?   Navigator.push(context, MaterialPageRoute(
                                                  builder: (context)=>RestProf(currentindex: 1,memberdate:widget.memberdate,
                                                    pagid:widget.pagid,
                                                    timid:widget.timid,))) : null;
                                            },
                                            child: Column(
                                              crossAxisAlignment:
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        ["user_id"].toString() ? GestureDetector(
                                            onTap: () {
                                              try {
                                                String chatID = makeChatId(timelineIdFoodi.toString(), _con.AccountPostData[index]['timeline_id'].toString());
                                                Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                        builder: (context) => ChatRoom(
                                                            timelineIdFoodi, NAME, _con.AccountPostData[index]
                                                        ...
                                                        return Padding(
                                                          ...
                                                          Wrap(
                                                            children: <
                                                              ...
                                                              userid
                                                                  .toString() ==
                                                                  _con.AccountPostData[index]['user_id']
                                                                      .toString()
                                                                  ? Padding(
                                                                padding: const EdgeInsets
                                                                    .all(
                                                                    ...
                                                                    Navigator
                                                                        ...
                                                                        MaterialPageRoute(
                                                                            builder: (
                                                                                context) =>
                                                                                EditPost(
                                                                                  desc:  _con.AccountPostData[index]['description']
                                                                                      .toString(),
                                                                                  postid:  _con.AccountPostData[index]["id"]
                                                                                      .toString(),
                                                                                )));
                                                                  },
                                                                  child: Container(
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: <
                                                                            ...
                                                                            _con.AccountPostData[index]["follow_status"] ==
                                                                                ...
                                                                                ? Text(
                                                                              "Unfollow  " +
                                                                                  _con.AccountPostData[index]["name"],
                                                                              style: f13w,
                                                                            )
                                                                                : Text(
                                                                              "Follow  " +
                                      ...
                                      Padding(
                                        ...
                                        ['post_images']
                                          ...
                                          imageUrl: "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F" +
                                                  _con.AccountPostData[
                                                  index]["shared_post_details"]["post_images"]
                                                  [0]['source']
                                                      .toString()
                                                      .replaceAll(" ", "%20") +
                                                  "?alt=media",
                                      ...
                                      children: <Widget>[
                                        _likes[index] ==
                                          ...
                                          onTap: () {
                                            ...
                                            _con.likeOtherPostTime(
                                                userid.toString(),postid.toString(),widget.id);
                                          },
                                          child: Row(
                                            children: <Widget>[
                                              Icon(
                                      ...
                                      /*  _save[index] == true ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              ...
                                              postid = _con.AccountPostData[index]["id"].toString();});
                                            _con.saveOtherPost(postid.toString(),userid.toString(),widget.id);
                                          },
                                          child: Row(
                                            children: <Widget>[
                                              Icon(
