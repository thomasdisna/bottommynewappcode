...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color(0xFF1E2026),
      bottomNavigationBar: Container(height: 110,color: Color(0xFF1E2026),child: Column(
        children: <Widget>[
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Row(
                  children: <Widget>[
                    Icon(Icons.star,size: 25,color: Color(0xFFffd55e)),
                    Icon(Icons.star,size: 25,color: Color(0xFFffd55e)),
                    Icon(Icons.star,size: 25,color: Color(0xFFffd55e)),
                    Icon(Icons.star,size: 25,color: Color(0xFFffd55e)),
                    Icon(Icons.star_border,size: 25,color: Color(0xFFffd55e)),
                  ],
                ),
                Text("4.0",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),)
              ],
            ),
          ),
          SizedBox(height: 10,),
