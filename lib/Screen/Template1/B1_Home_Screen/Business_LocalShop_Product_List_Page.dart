...
import 'Business_LocalShop_Add_Product_Page.dart';
...
class BusinessLocalShopProductListPage extends StatefulWidget {

  BusinessLocalShopProductListPage({this.pagid,this.timid,this.memberdate});
  String pagid,timid,memberdate;

  @override
  _BusinessLocalShopProductListPageState createState() => _BusinessLocalShopProductListPageState();
}

class _BusinessLocalShopProductListPageState extends StateMVC<BusinessLocalShopProductListPage> {
  ...
  _BusinessLocalShopProductListPageState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  @override
  void initState() {
    _con.LocalStoreProductList("2",widget.pagid,widget.timid);
    _con.getKitchenCategories("2");
    super.initState();
    setState(() {
    });
  }
  ...
  void toggleActivateAll(bool value) {
    if (switchControlAll == false) {
      _con.StoreActiveAllStatus(widget.pagid,widget.timid);
      setState(() {
  ...
  void searchOperation(String searchText) {
    ...
    _con.LSProductList.forEach((userDetail) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          _con.LSProductList.length>0 && _con.statusLSItem==false ? Expanded(
            child: SmartRefresher(
                    ...
                    children: <Widget>[
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(_con.LSACTIVE.toString(), style: f14wB)
                                  ],
                                ),
                              ),
                            ),
                            InkWell(
                              ...
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(
                                    builder: (context)=>BusinessLocalShopAddProductPage(pagid: widget.pagid,timid: widget.timid,memberdate: widget.memberdate,)
                                ));
                              },
                              child:  Container(
                                height: 60,
                      ...
                      Padding(
                        ...
                        child: _searchFollowerResult.length >0 ? Container(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                ItemDetailPage(tabb: 1,
                                                  member: widget.memberdate,typ: "2",timid: widget.timid,
                          ...
                          height:_con.LSProductList.length.toDouble()* 140,
                          child: ListView.builder(
                              physics: NeverScrollableScrollPhysics(),reverse: true,
                              itemCount: _con.LSProductList.length,
                              itemBuilder: (BuildContext context, int index) {
                                _con.LSProductList[index]['products_status'].toString()=="0" ? _active[index]=true : _active[index] = false;
                                _con.LSProductList[index]['placeorder_type']
                                    .toString() ==
                                    "0"
                                    ? _buynow[index] = false
                                    : _buynow[index] = true;
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) => ItemDetailPage(tabb: 1,
                                              member: widget.memberdate,typ: "2",timid: widget.timid,
                                              pageid: widget.pagid,
                                              productid: _con.LSProductList[index]['kitchen_item_id'].toString(),

                                              pic:_con.LSProductList[index]['kitchen_item_image'][0]["source"].toString(),
                                              )));
                                  },
                                  child: Column(
                                    children: <Widget>[
                                      Container(
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                             Opacity(
                                               opacity:_con.LSProductList[index]['products_status'].toString()=="0" ?  .2 : 1,
                                               child:  Row(
                                                 children: <Widget>[
                                                   Text(_con.LSProductList[index]['kitchen_item_name'],
                                                       style: f15wB),
                                                   SizedBox(
                                                     width: 5,
                                                   ),
                                                   Container(
                                                     ...
                                                     decoration: BoxDecoration(
                                                         border: Border.all(
                                                             color: _con.LSProductList[index]['products_type'].toString()=="1" ? Colors.red[700] : Colors.greenAccent[700]),
                                                         borderRadius:
                                                                ...
                                                                Row(
                                                                  children: <Widget>[
                                                                    Container(clipBehavior: Clip.antiAlias,
                                                                      ...
                                                                      CachedNetworkImage(
                                                                        imageUrl: "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F" +
                                                                            _con.LSProductList[index]['kitchen_item_image'][0]["source"].toString() +
                                                                            "?alt=media",
                                                                        fit:
                                                                        BoxFit.cover,
                                                                        placeholder: (context, ind) =>
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: <Widget>[
                                                                        Text(
                                                                          "In "+ _con.LSProductList[index]['products_category'][0]["parent_category_name"],
                                                                          style: f14w,
                                                                        ),
                                                                        SizedBox(height: 3),
                                                                        Text(
                                                                          "In "+_con.LSProductList[index]['products_category'][0]["category_name"],
                                                                          style: f14w,
                                                                        ),
                                                                        ...
                                                                        Row(
                                                                          children: <Widget>[
                                                                            ...
                                                                            Text(_con.LSProductList[index]['kitchen_item_rating'].toString(),
                                                                                style: f14gB),
                                                                            Text(" Ratings",
                                                                                style: f14g)
                                                                          ],
                                                                ...
                                                                child: Switch(
                                                                  onChanged: (bool val){
                                                                    if(_active[index]==true)
                                                                      setState(() {
                                                                        _active[index]=false;
                                                                        _con.LSProductList[index]['products_status']=1;
                                                                        _con.LSACTIVE=_con.LSACTIVE+1;
                                                                        _con.LocalStoreUpdateActiveStatus(_con.LSProductList[index]['kitchen_item_id'].toString(),"1",widget.pagid);
                                                                      });
                                                                    else
                                                                      setState(() {
                                                                        _active[index]=true;
                                                                        _con.LSProductList[index]['products_status']=0;
                                                                        _con.LSACTIVE=_con.LSACTIVE-1;
                                                                        _con.LocalStoreUpdateActiveStatus(_con.LSProductList[index]['kitchen_item_id'].toString(),"0",widget.pagid);
                                                                      });
                                                                  },
                                                                  value: _active[index],
                                                                  activeColor: Color(0xFFffd55e),
                                                                    ...
                                                                    val) {
                                                                      if (_buynow[index] ==
                                                                        ...
                                                                        setState(
                                                                              ...
                                                                              0;
                                                                              _con.buynoePreSETTING(
                                                                                  _con.LSProductList[index]['kitchen_item_id'].toString(),
                                                                                  "0");
                                                                            });
                                                                      else
                                                                        setState(
              ...
              :  _con.statusLSItem == false ? Padding(
            padding: EdgeInsets.only(top: MediaQuery.of(context).size.height/2.8),
            child: InkWell(
              splashColor: Color(0xFF48c0d8),
                  borderRadius: BorderRadius.circular(8),
