...
import 'business_restaurant_bottombar.dart';
...
class BusinessRestaurantAddProductPage extends StatefulWidget {

  BusinessRestaurantAddProductPage({this.timid,this.pagid,this.memberdate});
  String pagid,timid,memberdate;

  @override
  _BusinessRestaurantAddProductPageState createState() => _BusinessRestaurantAddProductPageState();
}

class _BusinessRestaurantAddProductPageState extends StateMVC<BusinessRestaurantAddProductPage> {
  File imageFile;
  int servicecharge=3;
  int product_cost=0;
  var distance_value;
  ...
  _BusinessRestaurantAddProductPageState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  _SubCatimagUpload() {
    _con.HomekitchenAddSubCategory(
        _subCatName.text,
        selected_category_id,
        categrynewimg.toString(),context,widget.pagid,widget.timid,"3"
    );
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) =>
                bottomNavBarRestaurant(memberdate: widget.memberdate,timid: widget.timid,pagid: widget.pagid,currentIndex: 3,upld: false,)));
    setState(() {subcataddalert=true; });
  ...
  _imagUpload() {
    ...
    _con.RestAddItem(context,userid.toString(),IMAGELIST.join(",").toString(),subCatg,"image",_displayName.text,_price.text,subCatg,hot_deal?"1":"0",switchControlBuyPre?"1":0,"3",
        subcategid.toString(),"business","1",quantity_value.toString(),servicecharge.toString(),_earnings.text,distance_value.toString(),widget.pagid,widget.timid,widget.memberdate,
        _subTitle.text,_discountPrice.text,((int.parse(_discountPrice.text)/int.parse(_price.text))*100).toString(),_packing.text,gst.toString());
    IMAGELIST = [];
    imageList = [];
    return Container();
  }
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButton(
                      ...
                      hint: Text("Select Category",style: f14w,),
                      ...
                      items: _con.RestaurantCategories.map((item) {
                                              ...
                                              itemBuilder: (context, ind1) {
                                                return GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        subCatImg= _con
                                                            .Subcategories[ind1]["categories_image"]
                                                            .toString();
                                                        subCatg = _con
              ...
              ShowBody==true?   Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(height: 15,),
                  Row(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: CachedNetworkImageProvider("https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+subCatImg+"?alt=media"),
                                    fit: BoxFit.cover),
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        border: Border.all(
                                            color: subcategtype=="1" ? Colors.red[600] : Colors.greenAccent[700]),
                                        borderRadius:
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(subCatg,style: f14wB,),
                    ),
                  ),
                  SizedBox(height: 20,),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Product Price",style: f14wB,),
                          SizedBox(height: 2,),
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(prefixText: "\u20B9 ",prefixStyle: f14w,
                            contentPadding: EdgeInsets.only(top: 6,left: 8),
                            hintText: "0",
                            hintStyle: f14w,
                            focusedBorder: OutlineInputBorder(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Discounted Price",style: f14wB,),
                          SizedBox(height: 2,),
                          Text("(Including GST)",style: f11w,),
                        ],
                      ),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Discount Percentage",style: f14wB,),
                      Container(
                        height: 30,
                        width: 90,
                        alignment: Alignment.centerLeft,
                        ...
                        child: Padding(
                          ...
                          child: Text( int.parse(_discountPrice.text)>0 ?
                          ((int.parse(_discountPrice.text)/int.parse(_price.text))*100).toString()+"%" : "0%",style: f14w,
                          ),
                        ),
                      )
                    ],
                    ...
                    children: [
                      Row(
                        children: [
                          Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Packaging Price",style: f14wB,),
                              SizedBox(height: 2,),
                        ...
                        children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              ...
                              Text( int.parse(_price.text)>0 && int.parse(_packing.text)>0 && int.parse(_discountPrice.text)>0 ? "\u20B9"+((/*int.parse(_price.text)*/-int.parse(_discountPrice.text))+int.parse(_packing.text)).toString() : "\u20B90",style: f18yB,),
                            ],
                          ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Container(height: 40,
          child: MaterialButton(
            ...
            child: Center(child: Text("Add",style: f16B,)),
          ),
        ),
      ),
    );
