...
class BusinessHomekitchenKitchenwall extends StatefulWidget {

  BusinessHomekitchenKitchenwall({this.pagid,this.timid,this.contro,this.contheight});
  String pagid,timid;
...
class _BusinessHomekitchenKitchenwall extends StateMVC<BusinessHomekitchenKitchenwall> {
  var timlineId;
  ...
  void initState() {
    ...
    setState(() {
      _con.AccountWall=BUS_KITCHEN_WALL;
    });
        ...
        body:Column(
          children: <Widget>[
            Padding(
              ...
              child: _con.AccountWall.length>0 ?Container(
