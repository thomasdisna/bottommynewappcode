...
class _bottomNavBarState extends State<bottomNavBarRestaurant> {
  ...
  Widget callPage(int current) {
    switch (current) {
      case 0:
        return new BusinessRestaurantTimeline(
          upld: widget.upld,
          timid: widget.timid,
      ...
      case 1:
        ...
        break;
      case 2:
        return new RestaurantNewEntryForm(
          memberdate: widget.memberdate,
          pagid: widget.pagid,
          timid: widget.timid,
        );
        break;
      case 3:
        return new BusinessRestaurantProductListPage(
          pagid: widget.pagid,
          timid: widget.timid,
          memberdate: widget.memberdate,
        );
