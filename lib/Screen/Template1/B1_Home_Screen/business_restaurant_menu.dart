...
class BusinessRestaurantMenu extends StatefulWidget {

  BusinessRestaurantMenu({this.pagid,this.timid,this.controo});
  String pagid,timid;
  ...
  @override
  _BusinessRestaurantMenuState createState() =>
      _BusinessRestaurantMenuState();
}
...
class _BusinessRestaurantMenuState extends StateMVC<BusinessRestaurantMenu> {
  HomeKitchenRegistration _con;
  _BusinessRestaurantMenuState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    setState(() {
      currentind=0;
      sel = 1;
      // cat_item= _con.RestaurantCategories[0]["name"].toString();
    });
    print("4444444444444444 "+_con.RestaurantCategories.toString());
    // _con.getRestaurantCategories("1");
    // _con.BusinessTimelineCategoryWiseListMenu("3",_con.RestaurantCategories[0]["id"].toString(),widget.pagid);
          ...
          onTap: () {
            Navigator.push(context, MaterialPageRoute(
                builder: (context)=> EachItemDetailPage(
                  page_id: _con.RProductList[index]["page_id"].toString(),
                  typ: "3",product_id:_con.RProductList[index]["kitchen_item_id"].toString() ,)
            ));
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: CachedNetworkImageProvider("https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                          _con.RProductList[index]["kitchen_item_image"][0]["source"].toString()+ "?alt=media",), fit: BoxFit.cover),
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    Text(
                                        _con.RProductList[index]["kitchen_item_name"].toString().length>14?_con.RProductList[index]["kitchen_item_name"].toString().substring(0,14)+"...":_con.RProductList[index]["kitchen_item_name"].toString(),
                                        style: f15wB
                                    ),
                                    SizedBox(
                                      width: 5,
                                    ),
                                    _con.RProductList[index]["products_type"].toString() == "1"?Container(
                                      height: 15,
                                      width: 15,
                                      decoration: BoxDecoration(
                                        border:
                                ...
                                Text(
                                  _con.RProductList[index]["products_category"][0]["category_name"].toString(),
                                  style: f14w,
                                ),
                                SizedBox(
                                  height: 3,
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                        _con.RProductList[index]["kitchen_item_rating"].toString(),
                                        style: f14gB
                                    ),
                                    SizedBox(
                                      width: 2,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(alignment: Alignment.centerLeft,
            child: sel==1   ? Column(
              children: [
                _con.statusRItem==true ? Container(
                  height: 115.0,
                  child: Center(
                    child: Visibility(
        ...
        _con.RProductList.length>0 && _con.statusRItem==false ?  Container(height: 115.0,alignment: Alignment.centerLeft,
                  child: ListView.builder(
                    itemCount: _con.RProductList.length,
                    ...
                    itemBuilder: (context, popInd) {
                      return InkWell(
                        onTap: () {
                          _con.RProductList[popInd]['products_status'].toString()=="1" ?
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context)=>EachItemDetailPage(typ: "1",
                                page_id: _con.RProductList[popInd]["page_id"].toString() ,
                                product_id: _con.RProductList[popInd]["kitchen_item_id"].toString(),)
                        ...
                        child: Opacity(
                          opacity:_con.RProductList[popInd]['products_status'].toString()=="1" ? 1 : .2,
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Container(clipBehavior: Clip.antiAlias,
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:"https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                        _con.RProductList[popInd]["kitchen_item_image"][0]["source"]+"?alt=media",
                                    fit: BoxFit.cover,
                                    placeholder:  (
                                        context,
                                        ind) =>
                                ...
                                Container(width: 95,
                                  child: Text(_con.RProductList[popInd]["kitchen_item_name"].toString().length>20 ?
                                  _con.RProductList[popInd]["kitchen_item_name"].toString().substring(0,20)+"..." :
                                  _con.RProductList[popInd]["kitchen_item_name"],textAlign: TextAlign.center,
                                    style: f14wB,
                                  ),
                                ),
                              ],
        ...
        _con.statusRItem==false ? Container(
            padding: EdgeInsets.only(top: 150),
            child: Center(child: Text("No Items",style: f16bB,))) : Container(),
              ],
            ) : sel==1  && _con.statusRItem==true ? Center(child: CircularProgressIndicator()) :
            sel ==2 ?
              ...
              itemBuilder: (context,inddd){
                return GestureDetector(
                  onTap: (){
                    ...
                    _con.BusinessTimelineSubCategoryItemListMenu("3",MenuSubCat[inddd]["id"].toString(),widget.pagid);
                  },
                  child: Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(8),
                        ...
                        onTap: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context)=>EachItemDetailPage(
                                ...
                                typ: "3",product_id: _con.TimeSubCatItemList[inditem]["kitchen_item_id"].toString(),)
                          )) : Fluttertoast.showToast(msg: "Product not available !!!",
                            toastLength: Toast.LENGTH_SHORT,
                            gravity: ToastGravity.TOP,
                            timeInSecForIosWeb: 35,
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: GestureDetector(
                                                                    onTap: (){
                                                                      ...
                                                                      ["kitchen_item_id"].toString(),"3",quantity.toString(),_con.TimeSubCatItemList[inditem]["kitchen_item_amount"].toString(),
