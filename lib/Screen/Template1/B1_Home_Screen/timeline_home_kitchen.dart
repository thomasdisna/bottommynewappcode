...
class TimelineHomeKitchen extends StatefulWidget {

  ScrollController kitcontrooo;
  TimelineHomeKitchen({this.kitcontrooo});

  @override
  _TimelineHomeKitchenState createState() => _TimelineHomeKitchenState();
}
var s="unlike";
var kitDate,Daatee;
class _TimelineHomeKitchenState extends StateMVC<TimelineHomeKitchen> {
  HomeKitchenRegistration _con;
  _TimelineHomeKitchenState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    setState(() {
      ...
      _con.HomeKitchenTimeline= KITCHENDATA;
      _con.popKitchenList= popKitchen;
          ...
          return Theme(
            data: ThemeData.light().copyWith(
              colorScheme: ColorScheme.fromSwatch(
                ...
                primaryColorDark: Color(0xFFffd55e),
                accentColor: Color(0xFFffd55e),
              ),
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          controller: widget.kitcontrooo,
          scrollDirection: Axis.vertical,
          child: _con.HomeKitchenTimeline.length>0 || _con.KitchenCategories.length>0 ? Column(
            children: <Widget>[
              Padding(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) => GestureDetector(
                      onTap: (){ Navigator.push(context, MaterialPageRoute(
                          builder: (context)=>Category_Detail(typ: 1,image: "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/"+_con.KitchenCategories[index]["categories_image"].toString()+"?alt=media",cat_item: _con.KitchenCategories[index]["name"].toString(),
                            cat_id: _con.KitchenCategories[index]["id"],)
                      ));},
                      child: Column(
                        children: <Widget>[
                          Container(
                          ...
                          CachedNetworkImage(
                              imageUrl:"https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/"
                                  +_con.KitchenCategories[index]["categories_image"].toString()+"?alt=media",fit: BoxFit.cover,
                            placeholder:  (
                              context,
                              ind) =>
                              Image
                          ...
                          Text(_con.KitchenCategories[index]["name"].toString(),style: f15wB,),
                  ...
                  children: <Widget>[
                    ...
                    Container(alignment: Alignment.centerLeft,
                      ...
                      child: sel==1 ? ListView.builder(
                        itemCount: _con.popKitchenList.length,
                        scrollDirection: Axis.horizontal,
                        shrinkWrap: true,
                        primary: false,
                        itemBuilder: (context, popInd) {
                          return InkWell(
                            onTap: () {
                              _con.popKitchenList[popInd]['products_status'].toString()=="1" ?
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context)=>EachItemDetailPage(typ: "1",
                                    page_id: _con.popKitchenList[popInd]["page_id"].toString(),
                                    product_id: _con.popKitchenList[popInd]["kitchen_item_id"].toString(),)
                            ...
                            child: Opacity(
                              opacity:_con.popKitchenList[popInd]['products_status'].toString()=="1" ? 1 : .2,
                              child: Padding(
                                  ...
                                  children: <Widget>[
                                    Container(clipBehavior: Clip.antiAlias,
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        _con.popKitchenList[popInd]["kitchen_item_image"][0]["source"]+"?alt=media",
                                        fit: BoxFit.cover,
                                        placeholder:  (
                                            context,
                                            ind) =>
                                    ...
                                    Container(width: 95,
                                      child: Text(_con.popKitchenList[popInd]["kitchen_item_name"].toString().length>20 ?
                                      _con.popKitchenList[popInd]["kitchen_item_name"].toString().substring(0,20)+"..." :
                                        _con.popKitchenList[popInd]["kitchen_item_name"],textAlign: TextAlign.center,
                                        style: f14wB,
                                      ),
                                    ),
                                  ],
              ...
              Container(
                height: UserKitchen.toDouble()* 242,
                child: ListView.builder(itemCount: _con.HomeKitchenTimeline.length,
                  scrollDirection: Axis.vertical,
                  physics: NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) {
                    kitDate = DateTime.parse(
                        _con.HomeKitchenTimeline[index]['created_at']);
                    Daatee =  DateFormat.yMMMd().format(kitDate);
                    return _con.HomeKitchenTimeline[index]["products"].length>0 ? Container(
                        height: 240,
                        width: MediaQuery.of(context).size.width,
                        child: Column(
                          ...
                          children: <Widget>[
                                ...
                                children: <Widget>[
                                  Row(
                                    ...
                                    children: <Widget>[
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  image: DecorationImage(
                                                      ...
                                                      fit: BoxFit.cover),
                                                  border: Border.all(color: _con.HomeKitchenTimeline[index]['picture'] ==
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              child: GestureDetector(
                                                onTap : (){
                                                  Navigator.push(context, MaterialPageRoute(
                                                    builder: (context)=>KitchenProf(currentindex: 1,memberdate: Daatee.toString(),pagid: _con.HomeKitchenTimeline[index]['page_id'].toString(),
                                                   timid: _con.HomeKitchenTimeline[index]['timeline_id'].toString(), )
                                                  ));
                                                },
                                                child: Column(
                                                  crossAxisAlignment:
                                                  ...
                                                  children: <Widget>[
                                                    Text(
                                                      _con.HomeKitchenTimeline[index]['business_name'],
                                                      style:f15wB,
                                                    ),
                                                    SizedBox(
                                                      height: 3,
                                                    ),
                                                    _con.HomeKitchenTimeline[index]['business_address'] !=null ?Row(
                                                      children: <Widget>[
                                                        Icon(
                                                          Icons.location_on,
                                                          color: Colors.grey,
                                                        ...
                                                        Text(_con.HomeKitchenTimeline[index]['business_address'],
                                                            style: f12g)
                                                      ],
                                                    ) : Container(),
                                                  ],
                                      ...
                                      SizedBox(width: 15),
                                      userid.toString()!=_con.HomeKitchenTimeline[index]["user_id"].toString()  ? Padding(
                                        padding: const EdgeInsets.only(top: 8),
                                        child: GestureDetector(
                                            onTap: () {
                                              try {
                                                String chatID = makeChatId(timelineIdFoodi.toString(), _con.HomeKitchenTimeline[index]["timeline_id"].toString());
                                                Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: <Widget>[
                                                Text(
                                                    " "+ _con.HomeKitchenTimeline[index]["rating"].toString()+ " ",
                                                    style: f14gB
                                                ),
                                                Text(
                                                    "Ratings",
                            ...
                            Padding(
                                ...
                                child: Container(
                                  height: 145,
                                  child: ListView.builder(
                                    itemCount: _con.HomeKitchenTimeline[index]["products"].length,
                                    scrollDirection: Axis.horizontal,
                                    itemBuilder: (context,ind){
                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            _con.HomeKitchenTimeline[index]['products'][ind]['products_status'].toString()=="1" ? Navigator.push(context, MaterialPageRoute(
                                                builder: (context)=>EachItemDetailPage(typ: "1",
                                                  page_id:  _con.HomeKitchenTimeline[index]['page_id'].toString(),
                                                  product_id: _con.HomeKitchenTimeline[index]["products"][ind]["kitchen_item_id"].toString(),)
                                            )) :  Fluttertoast.showToast(msg: "Product not available !!!",
                                              toastLength: Toast.LENGTH_SHORT,
                                              gravity: ToastGravity.TOP,
                                              timeInSecForIosWeb: 35,
                                          ...
                                          child: Opacity(
                                            opacity:_con.HomeKitchenTimeline[index]['products'][ind]['products_status'].toString()=="0" ?  .2 : 1,
                                            child: Container(
                                              height: 135.0,
                                              width: 280,
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          ...
                                                                          image: DecorationImage(
                                                                              image: CachedNetworkImageProvider("https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                                                                  _con.HomeKitchenTimeline[index]['products'][ind]
...
//                                 height: 22,/
                                                                    ...
                                                                    GestureDetector(
                                                                      onTap: (){
                                                                       ...
                                                                       if(_con.HomeKitchenTimeline[index]['products'][ind]['products_status'].toString()=="1"){
                                                                         if(_con.HomeKitchenTimeline[index]['products'][ind]
                                                                        ["placeorder_type"].toString()=="0")
                                                                        {_con.buyNow(context,userid.toString(),_con.HomeKitchenTimeline[index]['products'][ind]
                                                                        ["kitchen_item_id"].toString(),"1","1",_con.HomeKitchenTimeline[index]['products'][ind]
                                                                        ["kitchen_item_amount"].toString(),_con.HomeKitchenTimeline[index]["page_id"].toString(),
                                                                            _con.HomeKitchenTimeline[index]['products'][ind]["kitchen_item_name"],1,
                                                                            _con.HomeKitchenTimeline[index]['business_name'],
                                                                            _con.HomeKitchenTimeline[index]['business_address']
                                                                        );}
                                                                        ...
                                                                        ["placeorder_type"].toString()=="1"){
                                                                          setState(() {
                                                                            ...
                                                                            quantity = _con.HomeKitchenTimeline[index]['products'][ind]
                                                                            ["products_quantity"];
                                                                            total = _con.HomeKitchenTimeline[index]['products'][ind]
                                                                            ["kitchen_item_amount"];
                                                                            sel_ind = ind;
                                                                             var a =selectedTime.toString().replaceAll("TimeOfDay(", "").replaceAll(")", "").toString().split(":");
                                                                             print("dfgh "+a.toString());
                                                                                        ...
                                                                                        child: Wrap(
                                                                                          children: [
                                                                                                  ...
                                                                                                  GestureDetector(
                                                                                                    ...
                                                                                                    child: Container(
                                                                                                      ...
                                                                                                      child: Center(child: Padding(
                                                                                                        ...
                                                                                                        child: Text("Change Schedule",style: f14B,),
                                                                                                      )),
                                                                                                    ),
                                                                                                  ),
                                                                                                ],
                                                                                                          ...
                                                                                                          children: [
                                                                                                            Row(
                                                                                                              children: [
                                                                                                                ...
                                                                                                                Column(crossAxisAlignment: CrossAxisAlignment.start,
                                                                                                                  children: [
                                                                                                                    Text(_con.HomeKitchenTimeline[index]['products'][ind]["kitchen_item_name"].toString().length>14 ?
                                                                                                                    _con.HomeKitchenTimeline[index]['products'][ind]["kitchen_item_name"].toString().substring(0,14)+"..." :
                                                                                                                    _con.HomeKitchenTimeline[index]['products'][ind]
                                                                                                                    ["kitchen_item_name"].toString(), style: f15wB),
                                                                                                                    SizedBox(height: 3,),
                                                                                                                    Text(
                                                                                                                      _con.HomeKitchenTimeline[index]['business_name'], style:f14wB,),
                                                                                                                    SizedBox(height: 3,),
                                                                                                                    Text("\u20B9 "+
                                                                                                                        _con.HomeKitchenTimeline[index]['products'][ind]
                                                                                                                  ...
                                                                                                                  InkWell(
                                                                                                                    onTap: () {
                                                                                                                      state(() {
                                                                                                                        ...
                                                                                                                        total = quantity* _con.HomeKitchenTimeline[index]['products'][ind]["kitchen_item_amount"];
                                                                                                                      });
                                                                                                                    },
                                                                                                                    child: Container(
                                                                                                                      height: 30.0,
                                                                                            ...
                                                                                            Padding(
                                                                                              ...
                                                                                              child: GestureDetector(
                                                                                                onTap: (){
                                                                                                  _con.Preorder(context,userid.toString(),_con.HomeKitchenTimeline[index]['products'][ind]
                                                                                                  ["kitchen_item_id"].toString(),"1",quantity.toString(),_con.HomeKitchenTimeline[index]['products'][ind]
                                                                                                  ["kitchen_item_amount"].toString(),_con.HomeKitchenTimeline[index]["page_id"].toString(),listDate[0].toString(),
                                                                                                      selectedTime.toString().replaceAll("TimeOfDay(", "").replaceAll(")", "").toString(),
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Row(
                                                                    children: <Widget>[
                                                                      GestureDetector(
                                                                        onTap:(){
                                                                          if(_con.HomeKitchenTimeline[index]['products'][ind]['products_status'].toString()=="1"){ _con.AddtoPurchaseList(userid.toString(),_con.HomeKitchenTimeline[index]['products'][ind]
                                                                          ["kitchen_item_id"].toString(),"1","1",_con.HomeKitchenTimeline[index]['products'][ind]
                                                                          ["kitchen_item_amount"].toString(),_con.HomeKitchenTimeline[index]["page_id"].toString());
                                                                          setState(() {
                                                                      ...
                                                                      GestureDetector(
                                                                        onTap: () {
                                                                          if(_con.HomeKitchenTimeline[index]['products'][ind]['products_status'].toString()=="1"){if (_con.HomeKitchenTimeline[index]['products'][ind]
                                                                            ["is_favorite"]==true) {
                                                                          ...
                                                                          _con.addFavourite(_con.HomeKitchenTimeline[index]['products'][ind]
                                                                          ["kitchen_item_id"].toString());}
                                                                        },
                                                                        child: _con.HomeKitchenTimeline[index]['products'][ind]
                                                                        ["is_favorite"]==true
                                                                            ? Icon(Icons.favorite,
                                                                            color: Color(0xFFffd55e))
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(width: 80,
              child: Text(
                _lunch.title,textAlign: TextAlign.center,
                style: f14wB,
              ),
            ),
          ],
