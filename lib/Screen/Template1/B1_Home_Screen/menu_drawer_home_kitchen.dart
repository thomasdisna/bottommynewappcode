...
class MenuDrawerHomeKitchen extends StatefulWidget {
  @override
  _MenuDrawerHomeKitchenState createState() => _MenuDrawerHomeKitchenState();
}
class _MenuDrawerHomeKitchenState extends StateMVC<MenuDrawerHomeKitchen> {
  ...
  _MenuDrawerHomeKitchenState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  submit(){
    ...
    if (!form.validate()) {
      ...
      form.save();
      _con.HomeKitchenForm(context,_kitchenName.text.toString(),_FullAddress.text.toString(),
      _username.text.toString(),_Mobile.text.toString(),_Email.text.toString(),
          selected_category_id,"1",selected_State,selected_district,_place.text,
