...
var s = "unlike";
var b = "unmark";
class BusinessHomeKitchenVideos extends StatefulWidget {
  BusinessHomeKitchenVideos({this.contro});
  ScrollController contro;

  @override
  _BusinessHomeKitchenVideosState createState() => _BusinessHomeKitchenVideosState();
}

class _BusinessHomeKitchenVideosState extends State<BusinessHomeKitchenVideos> {
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            VideoDetailPage(Name: "Sofis Kitchen",)));
                              },
                              child: Padding(
