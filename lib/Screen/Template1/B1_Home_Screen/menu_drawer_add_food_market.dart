...
class MenuDrawerFoodMarketAdd extends StatefulWidget {
  @override
  _MenuDrawerFoodMarketAddState createState() => _MenuDrawerFoodMarketAddState();
}

class _MenuDrawerFoodMarketAddState extends State<MenuDrawerFoodMarketAdd> {
  int selectedRadio;
