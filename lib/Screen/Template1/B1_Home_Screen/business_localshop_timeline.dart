...
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_blog.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_chat.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_localshopwall.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_menu.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_orders.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_reviews.dart';
import 'package:Butomy/Screen/Template1/B1_Home_Screen/business_localshop_videos.dart';
...
import 'business_local_shop_new_entry.dart';
DateTime _LSdate;
var LSMonth_year;
...
class BusinessLocalShopTimeline extends StatefulWidget {
  BusinessLocalShopTimeline({Key key,this.pagid,this.timid,this.memberdate,this.upld}) : super(key: key);
  String pagid,timid,memberdate;
  bool upld;

  @override
  _BusinessLocalShopTimelineState createState() =>
      _BusinessLocalShopTimelineState();
}

class _BusinessLocalShopTimelineState extends StateMVC<BusinessLocalShopTimeline> with SingleTickerProviderStateMixin {
  HomeKitchenRegistration _con;
  _BusinessLocalShopTimelineState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  getLocalStorepageTime() async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    pageid_LocalStore = prefs.getString('LS_page_id');
    String str = pageid_LocalStore.toString();
  }
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Text(
                        "See " + _con.homeKitchenProfileData["data"][0]["name"],
                        style: f14w,
                      ),
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => BusinessAboutInfo(typ: "2",pagid: widget.pagid,timid: widget.timid,
                                    )));
                          },
                          child: Text(
                              "About Info",
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(
                          builder: (context)=>BusinessPosts(id: widget.timid,type: "2",
                          pagid: widget.pagid,memberdate: widget.memberdate,timid: widget.timid,)
                      ));
                    },
                    child: Row(
                      children: <Widget>[
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) =>BusinessFollowingPage(pageId: widget.pagid.toString(),type: "2",)));
                    },
                    child: Row(
                      children: <Widget>[
                        Text(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: TabBarView(
                  controller: _tabContoller,
                  children: <Widget>[
                    BusinessLocalShopwall(pagid: widget.pagid,timid: widget.timid,controo: _timControoooo,contheight: _fromTop!=0 ? MediaQuery.of(context).size.height - 196 : MediaQuery.of(context).size.height - 519,),
                    BusinessLocalShopMenu(pagid: widget.pagid,timid: widget.timid,controo: _timControoooo,),
                    BusinessLocalShopVideos(controo: _timControoooo,),
                    BusinessLocalShopReviews(controo: _timControoooo,),
                    BusinessLocalShopBlog(contro:  _timControoooo,timid: widget.timid,)
                  ],
                ),
              )
            ],
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Column(
              children: <Widget>[
                stoupldggg==true?  ImageUploadProgress() : Container(),
                Container(
                  height: 150,
                  width: MediaQuery.of(context).size.width,
                  child: Image.asset("assets/Template1/image/Foodie/store_back.jpg",fit: BoxFit.cover,),
                ),
                _kitchenDetails,
                _shareBagde,
                _follow,
                    ...
                    'Inventory',
                        () => {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => BusinessLocalShopProductListPage(memberdate: widget.memberdate,pagid: widget.pagid,timid: widget.timid,)))
                    }),
                CustomListTile2(
                    "assets/Template1/image/Foodie/icons/rating.png",
                    'Ratings',
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                        builder: (context) => BusinessLocalShopChatList(memberdate: widget.memberdate,timid: widget.timid,pagid: widget.pagid,
                ...
                Container(
                  ...
                  child: FloatingActionButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(
                          builder: (context) => LocalShopNewEntryForm(timid: widget.timid,pagid: widget.pagid,memberdate: widget.memberdate,)
                      ));
                    },
                    elevation: 5,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                        builder: (context) => BusinessLocalShopOrderPage(memberdate: widget.memberdate,pagid: widget.pagid,timid: widget.timid,)
                    ));
                  },
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
