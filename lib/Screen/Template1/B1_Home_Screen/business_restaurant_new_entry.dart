...
import 'package:Butomy/Screen/Template1/B1_Home_Screen/Business_Restaurant_Add_Product_Page.dart';
...
import 'Business_Restaurant_Product_List_Page.dart';
...
class RestaurantNewEntryForm extends StatefulWidget {

  RestaurantNewEntryForm({this.pagid,this.timid,this.memberdate});
  String pagid,timid,memberdate;

  @override
  _RestaurantNewEntryFormState createState() => _RestaurantNewEntryFormState();
}

class _RestaurantNewEntryFormState extends StateMVC<RestaurantNewEntryForm> {
  ...
  _RestaurantNewEntryFormState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  _imagBlogUpload() {
    _location.toString().length > 5 && _utube.text == null && _utube.text.isEmpty
        ...
        _location, lat, lng,widget.timid,widget.memberdate,"3")
        ...
        _location, lat, lng,widget.timid,widget.memberdate,"3",_utube.text) :  _location.toString().isEmpty && _utube.text != null &&
        _utube.text.isNotEmpty ? _con.postBlogPost3(context,widget.pagid.toString(), _desc.text,_blogTitle.text,
        IMAGELISTS.join(",").toString(), "image", "blog",widget.timid,widget.memberdate,"3",_utube.text) : _con.postBlogPost2(context,widget.pagid.toString(),
        _desc.text,_blogTitle.text, IMAGELISTS.join(",").toString(), "image", "blog",widget.timid,widget.memberdate,"3");
    typ = "";
    _video = null;
    // _uploadTask=null;
    return Container();
  ...
  _imagUpload() {
    ...
    _location.toString().length > 5
        ...
        IMAGELISTS.join(",").toString(), "image", _location, lat, lng,widget.timid,widget.memberdate,"3")
        : _con.posttimelineWallPost2(context,
      widget.pagid,
      _desc.text,
      IMAGELISTS.join(",").toString(),
      "image",widget.timid,widget.memberdate,"3"
    );
                          ...
                          if (_desc.text.length > 0 && typ == "") {
                            ...
                            if (_desc.text.contains("https") == true ||
                                      ...
                                      FetchPreview().fetch(url).then((res) {
                                        setState(() {
                                          ...
                                          _location.toString().length > 5
                                              ...
                                              data['image'].toString(),
                                              data['title'].toString(),
                                              data['description'].toString(),data['site'].toString(),url,widget.timid,widget.memberdate,"3")
                              ...
                              _location.toString().length > 5
                                  ...
                                  _desc.text, _location, lat, lng, "", "", "","","",widget.timid,widget.memberdate,"3")
                                  : _con.posttimelineDescPost1(context,
                                  widget.pagid, _desc.text, "", "", "","","",widget.timid,widget.memberdate,"3");
                            }
                            ...
                            if (video_type == "utube") {
                              _location.toString().length > 5
                                 ...
                                 widget.pagid,
                                  ...
                                  _location,
                                  lat,
                                  lng,widget.timid,widget.memberdate,"3")
                                  : _con.posttimelineUTubeVideoPost2(context,
                               widget.pagid,
                                _desc.text,
                                _utube.text,widget.timid,widget.memberdate,"3"
                              );
                              Fluttertoast.showToast(
                                msg: " Uploading Post ",
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context)=>BusinessRestaurantAddProductPage(timid: widget.timid,pagid: widget.pagid,memberdate: widget.memberdate,)
                              ));
                            },
                            child: Column(
                              children: <Widget>[
