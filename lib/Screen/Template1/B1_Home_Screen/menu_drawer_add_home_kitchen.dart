...
class MenuDrawerHomeKitchenAdd extends StatefulWidget {
  @override
  _MenuDrawerHomeKitchenAddState createState() => _MenuDrawerHomeKitchenAddState();
}

class _MenuDrawerHomeKitchenAddState extends State<MenuDrawerHomeKitchenAdd> {
  int selectedRadio;
