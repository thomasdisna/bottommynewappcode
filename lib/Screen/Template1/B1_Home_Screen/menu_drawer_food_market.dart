...
class MenuDrawerFoodMarket extends StatefulWidget {
  @override
  _MenuDrawerFoodMarketState createState() => _MenuDrawerFoodMarketState();
}

class _MenuDrawerFoodMarketState extends StateMVC<MenuDrawerFoodMarket> {
  ...
  _MenuDrawerFoodMarketState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  submit(){
    ...
    if (!form.validate()) {
      ...
      form.save();
      _con.LocalStoreForm(context,_kitchenName.text.toString(),_FullAddress.text.toString(),
          _username.text.toString(),_Mobile.text.toString(),_Email.text.toString(),
          selected_category_id,"2",selected_State,selected_district,_place.text,
