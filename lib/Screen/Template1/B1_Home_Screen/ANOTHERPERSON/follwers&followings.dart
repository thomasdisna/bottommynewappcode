...
class OtherFollowers extends StatefulWidget {
  OtherFollowers({
    Key key,
    this.statusIndex,this.id,this.followers,this.following
  }) : super(key: key);
  int statusIndex;
  String id,followers,following;

  @override
  _OtherFollowersState createState() => _OtherFollowersState();
}

class _OtherFollowersState extends StateMVC<OtherFollowers>
    with SingleTickerProviderStateMixin {
  TabController _tabContoller;
  TextEditingController _follow = TextEditingController();
  TextEditingController _following = TextEditingController();
  TimelineWallController _con;

  _OtherFollowersState() : super(TimelineWallController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    super.initState();
    print("another id "+widget.id);
    _con.getFollowers(widget.id.toString(),userid.toString());
    _con.getOtherFollowing(widget.id.toString(),userid.toString());
    _tabContoller =
  ...
  Widget build(BuildContext context) {
    _con.getFollowers(widget.id.toString(),userid.toString());
    searchOperation(_follow.text);
    searchOperationFollowing(_following.text);
    _con.getOtherFollowing(widget.id.toString(),userid.toString());
    var _searchFollow = Padding(
    ...
    Column(
      children: [
        ...
        Container(
          height: _con.followersList.length.toDouble() * 55.8,
          ...
          child: _searchFollowerResult.length != 0 && _con.statusFollower==false
                ...
                return Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            _searchFollowerResult[index]['user_id'].toString()!=userid?GestureDetector(
                                onTap: () {

                                  _searchFollowerResult[index]['following_status']==true? showDialog(
                                      context: context,
                                      builder: (
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: 25,
                                    width: 85,
                                    child: _searchFollowerResult[index]['following_status']==true?Center(
                                      child: Text(
                                        "Unfollow",
                                        style: f14B,
                                      ),
              ...
              itemBuilder: (BuildContext context, int index) {
                print("status ind "+index.toString()+" "+_con.followersList[index]['following_status'].toString());
                return Padding(
                    padding: EdgeInsets.only(
                        left: 10.0, right: 5.0, top: 12, bottom: 12),
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            _con.followersList[index]['user_id'].toString()!=userid.toString()?GestureDetector(
                                onTap: () {
                                  _con.followersList[index]['following_status']==true? showDialog(
                                      context: context,
                                      builder: (
                                          BuildContext context) {
                                        return AlertDialog(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: 25,
                                    width: 85,
                                    child: _con.followersList[index]['following_status']==true?Center(
                                      child: Text(
                                        "Unfollow",
                                        style: f14B,
                                      ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            _searchFollowingResult[index]['user_id'].toString()!=userid ?Padding(
                              ...
                              child: Container(
                                ...
                                child: MaterialButton(
                                  color: Color(0xFF48c0d8),
                                  child: Text(
                                    _searchFollowingResult[index]['following_status']==true ?  "Unfollow" : "Follow",
                                    style: f14B,
                                  ),
                                  onPressed: () {
                                    _searchFollowingResult[index]['following_status']==true?  showDialog(
                                        context: context,
                                        builder: (
                                            BuildContext context) {
                                          return AlertDialog(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            _con.followingList[index]['user_id'].toString()!=userid ?Padding(
                              padding: const EdgeInsets.only(right: 5),
                              child: Container(
                                height: 25,
                                child: MaterialButton(
                                  color: Color(0xFF48c0d8),
                                  child: Text(
                                    _con.followingList[index]['following_status']==true ?  "Unfollow" : "Follow",
                                    style: f14B,
                                  ),
                                  onPressed: () {
                                    _con.followingList[index]['following_status']==true?  showDialog(
                                        context: context,
                                        builder: (
                                            BuildContext context) {
                                          return AlertDialog(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            ...
            new Tab(
              child: Text(widget.following+" Following", style: f15B),
            ),
          ],
