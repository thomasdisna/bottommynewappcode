...
class AnotherPersonalPosts extends StatefulWidget {


  AnotherPersonalPosts({Key key,this.id}) : super(key: key);
  String id;


  @override
  _AnotherPersonalPostsState createState() => _AnotherPersonalPostsState();
}

class _AnotherPersonalPostsState extends StateMVC<AnotherPersonalPosts> {
  ...
  _AnotherPersonalPostsState() : super(TimelineWallController()) {
    _con = controller;
  }
                      ...
                      textSpan == true*/ && _sharedshowml[index]==true?
                                      ...
                                      Padding(
                                        ...
                                        ['post_images']
                                          ...
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(
                                                builder: (context) => GalleryScreen(ImageList: _con.AccountPostData[index]["shared_post_details"]['post_images'],)
                                            ));
                                          },
                                              child: Container(
                                          height: 350,
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(
                                                ...
                                                _con.AccountPostData[index]["shared_post_details"]['post_images'],)
                                            ));
                                          },
                                          child: Container(
                                              height: 350.0,
                      ...
                      textSpan == true*/ && _showSharedutube[index]==true?
                            ...
                            Padding(
                              ...
                              ['post_images']
                                ...
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(
                                      builder: (context) => GalleryScreen(ImageList: _con.AccountPostData[index]['post_images'],)
                                  ));
                                },
                                    child: Container(
                                height: 350,
