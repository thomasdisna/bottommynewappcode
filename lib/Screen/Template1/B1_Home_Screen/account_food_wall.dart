...
class AccountFoodWall extends StatefulWidget {

  ScrollController accwallcontro;

  AccountFoodWall({this.accwallcontro});

  @override
  _AccountFoodWallState createState() => _AccountFoodWallState();
}
class _AccountFoodWallState extends StateMVC<AccountFoodWall> {
  TimelineWallController _con;

  _AccountFoodWallState() : super(TimelineWallController()) {
    _con = controller;
  }
  @override
  void initState() {
              ...
              Padding(
                ...
                child: _con.AccountWall.length>0 && _con.statusAccWall == false? Container(
                    ...
                    child:GridView.builder(
                      controller: widget.accwallcontro,
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.of(context).push(PageRouteBuilder(
                                    ...
                                    new AccountFoodWallPostDetailPage(timid: timelineIdFoodi.toString(),id: userid,sel_ind: index,total_ind: _con.AccountWall.length.toInt(),),
