...
import 'package:Butomy/Screen/Template1/B1_Home_Screen/DETAILSBUSINESPROF/sto_wall.dart';
...
DateTime _LSdate;
var LSMonth_year;
class StoreProf extends StatefulWidget {
  StoreProf({Key key,this.pagid,this.timid,this.memberdate,this.currentindex}) : super(key: key);
  String pagid,timid,memberdate;
  int currentindex;
  @override
  _StoreProfState createState() =>
      _StoreProfState();
}

class _StoreProfState extends StateMVC<StoreProf> with SingleTickerProviderStateMixin {
  HomeKitchenRegistration _con;
  _StoreProfState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
...
//                        ));
                      ...
                      child: Container(width: MediaQuery.of(context).size.width-170,
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                                _con.homeKitchenProfileData["data"][0]["name"],maxLines: 1,overflow: TextOverflow.ellipsis,
                                style: f16wB
                            ),
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => ChatRoom(
                                              timelineIdFoodi,
                                              NAME,
                                              _con.homeKitchenProfileData["data"][0]["device_token"]
                                                  .toString(),
                                              widget.timid
                                                  .toString(),
                                              chatID,
    ...
    var _follow =    _con.homeKitchenProfileData!=null ? Padding(
        padding: EdgeInsets.only(left: 3.0, right: 3.0, top: 2, bottom: 10),
        child: InkWell(
          onTap: () {},
          child: Container(
            height: 38.0,
      ...
      child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                height:_fromTop!=0 ? MediaQuery.of(context).size.height - 137 : MediaQuery.of(context).size.height - 460,
                // padding: EdgeInsets.only(bottom: 200),
                child: TabBarView(
                  controller: _tabContoller,
                  children: <Widget>[
                    OtherLocalShopwall(pagid: widget.pagid,timid: widget.timid,controo: _timControoooo,contheight: _fromTop!=0 ? MediaQuery.of(context).size.height - 133 : MediaQuery.of(context).size.height - 453,),
    ...
    return Scaffold(
      ...
      body: _con.homeKitchenProfileData!=null ? _body : Center(
