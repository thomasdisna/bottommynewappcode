...
import 'kit_wallll.dart';

DateTime _date;
var Month_year;

class KitchenProf extends StatefulWidget {
  KitchenProf({Key key, this.memberdate, this.timid, this.pagid,this.currentindex})
      : super(key: key);
  ...
  @override
  _KitchenProfState createState() => _KitchenProfState();
}

class _KitchenProfState extends StateMVC<KitchenProf>
    with SingleTickerProviderStateMixin {
  HomeKitchenRegistration _con;

  _KitchenProfState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
                                ...
                                children: <Widget>[
                                  Text(
                                    _con.homeKitchenProfileData["data"][0]
                                        ["name"],
                                    // "abc",
                                    style: f16wB,maxLines: 1,overflow: TextOverflow.ellipsis,
                                  ),
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context)=>BusinessPosts(id: widget.timid,type: "1",memberdate: widget.memberdate,pagid: widget.pagid,timid: widget.timid,)
                          ));
                        },
                        child: Row(
                          children: <Widget>[
