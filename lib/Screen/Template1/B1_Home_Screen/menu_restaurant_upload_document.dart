...
class RestbusinessUpload extends StatefulWidget {
  RestbusinessUpload({this.pagid, this.timid,this.name,this.indexx,this.username,this.place});

  String pagid, timid,name,username,place;
  int indexx;

  @override
  _RestbusinessUploadState createState() => _RestbusinessUploadState();
}



class _RestbusinessUploadState extends StateMVC<RestbusinessUpload> {

  String prof_img;
  Validations validations = new Validations();
  HomeKitchenRegistration _con;

  _RestbusinessUploadState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
...
class ImageUploadProgress extends StatefulWidget {
  ...
  ImageUploadProgress({this.accnum,this.accname,this.branchh,this.fssaiimg,
    ...
    this.index,this.name,this.place,this.username,this.bankname});
...
class _ImageUploadProgressState extends StateMVC<ImageUploadProgress> {
  ...
  _setval(){
    _con.LocalStoDocumentUpload(context,widget.panimg,
        widget.fssaiimg, "3", widget.pagee, widget.timm,widget.accname,widget.accnum,
