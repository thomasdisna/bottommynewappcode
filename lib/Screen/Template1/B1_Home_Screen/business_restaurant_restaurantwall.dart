...
class BusinessRestaurantwall extends StatefulWidget {

  BusinessRestaurantwall({this.pagid,this.timid,this.controo,this.contheight});
  String pagid,timid;
  double contheight;
...
class _BusinessRestaurantwall extends StateMVC<BusinessRestaurantwall> {
  var timlineId;
  ...
  void initState() {
    ...
    setState(() {
      _con.RESTAccountWall=BUS_RESTAURANT_WALL;
    });
        ...
        body:Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: _con.RESTAccountWall.length>0 ? Container(
