...
class BusinessLocalShopMenu extends StatefulWidget {

  BusinessLocalShopMenu({this.pagid,this.timid,this.controo});
  String pagid,timid;
  ScrollController controo;

  @override
  _BusinessLocalShopMenuState createState() =>
      _BusinessLocalShopMenuState();
}
var s = "unlike";
String temp = "5 Pcs + 2 Tomato Ketchup";
List<String> catArr = ["All","Snacks","Cakes","Meals"];
List categoryAll = ["All"];
class _BusinessLocalShopMenuState extends StateMVC<BusinessLocalShopMenu> {
  HomeKitchenRegistration _con;
  _BusinessLocalShopMenuState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    super.initState();
    _con.LocalStoreProductList("2",widget.pagid,widget.timid);
    ...
    setState(() {
      ...
      currentind=0;
       sel=1;
      // main_currentind=0;
      // cat_item= _con.StoreCategories[0]["name"].toString();
    });
    print("4444444444444444 "+_con.StoreCategories.toString());
    // _con.getStoreCategories("1");
    // _con.BusinessTimelineCategoryWiseListMenu("2",_con.StoreCategories[0]["id"].toString(),widget.pagid);
  ...
  Widget build(BuildContext context) {
    ...
    var _mainList = ListView.builder(
          ...
          onTap: () {
            Navigator.push(context, MaterialPageRoute(
                builder: (context)=> EachItemDetailPage(
                  page_id: _con.LSProductList[index]["page_id"].toString(),
                  typ: "2",product_id:_con.LSProductList[index]["kitchen_item_id"].toString() ,)
            ));
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: CachedNetworkImageProvider("https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                          _con.LSProductList[index]["kitchen_item_image"][0]["source"].toString()+ "?alt=media",), fit: BoxFit.cover),
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    Text(
                                        _con.LSProductList[index]["kitchen_item_name"].toString().length>14?_con.LSProductList[index]["kitchen_item_name"].toString().substring(0,14)+"...":_con.LSProductList[index]["kitchen_item_name"].toString(),
                                        style: f15wB
                                    ),
                                    SizedBox(
                                      width: 5,
                                    ),
                                    _con.LSProductList[index]["products_type"].toString() == "1"?Container(
                                      height: 15,
                                      width: 15,
                                      decoration: BoxDecoration(
                                        border:
                                        Border.all(color: Colors.red[600]),
                                        borderRadius: BorderRadius.circular((2)),
                                      ),
                                      child: Icon(Icons.brightness_1,
                                          color: Colors.red[600], size: 8),
                                    ):Container(
                                      height: 15,
                                      width: 15,
                                      decoration: BoxDecoration(
                                ...
                                Text(
                                  _con.LSProductList[index]["products_category"][0]["category_name"].toString().length>14?_con.LSProductList[index]["products_category"][0]["category_name"].toString().substring(0,14)+"...":_con.LSProductList[index]["products_category"][0]["category_name"].toString(),
                                  style: f14w,
                                ),
                                SizedBox(
                                  height: 3,
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                        _con.LSProductList[index]["kitchen_item_rating"].toString(),
                                        style: f14gB
                                    ),
                                    SizedBox(
                                      width: 2,
                                ...
                                Row(
                                  children: <Widget>[
                                    Text(
                                      "\u20B9  "+_con.LSProductList[index]["kitchen_item_amount"].toString(),
                                      style: f14wB,
                                    ),
                                    Text(
                                      " (Min 5 Pcs)",
      ...
      itemCount: _con.LSProductList.length,
    );
    var _switchVegEgg = Container(
      child: Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(alignment: Alignment.centerLeft,
            child: sel==1  ? Column(
              children: [
                _con.statusLSItem==true ? Container(
                  height: 115.0,
                  child: Center(
                    child: Visibility(
                        visible: _con.statusLSItem,
                        child: CircularProgressIndicator()
                    ),
                  ),
                ) : Container(),
                _con.LSProductList.length>0 && _con.statusLSItem==false ? Container(height: 115.0,alignment: Alignment.centerLeft,
                  child: ListView.builder(
                    itemCount: _con.LSProductList.length,
                    ...
                    itemBuilder: (context, popInd) {
                      return InkWell(
                        onTap: () {
                          _con.LSProductList[popInd]['products_status'].toString()=="1" ?
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context)=>EachItemDetailPage(typ: "1",
                                page_id: _con.LSProductList[popInd]["page_id"].toString(),
                                product_id: _con.LSProductList[popInd]["kitchen_item_id"].toString(),)
                        ...
                        child: Opacity(
                          opacity:_con.LSProductList[popInd]['products_status'].toString()=="1" ? 1 : .2,
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Container(clipBehavior: Clip.antiAlias,
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:"https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                        _con.LSProductList[popInd]["kitchen_item_image"][0]["source"]+"?alt=media",
                                    fit: BoxFit.cover,
                                    placeholder:  (
                                        context,
                                        ind) =>
                                ...
                                Container(width: 95,
                                  child: Text(_con.LSProductList[popInd]["kitchen_item_name"].toString().length>20 ?
                                  _con.LSProductList[popInd]["kitchen_item_name"].toString().substring(0,20)+"..." :
                                  _con.LSProductList[popInd]["kitchen_item_name"],textAlign: TextAlign.center,
                                    style: f14wB,
                                  ),
                                ),
                              ],
                ...
                ) : _con.statusLSItem==false ? Container(
                   padding: EdgeInsets.only(top:150),
                    child: Center(child: Text("No Items",style: f16bB,))) : Container(),
              ],
            ) : sel==1  && _con.statusLSItem==true ? Center(child: CircularProgressIndicator()) :
            sel ==2 ?
              ...
              itemBuilder: (context,inddd){
                return GestureDetector(
                  onTap: (){
                    ...
                    _con.BusinessTimelineSubCategoryItemListMenu("2",MenuSubCat[inddd]["id"].toString(),widget.pagid);
                  },
                  child: Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(8),
                        ...
                        onTap: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context)=>EachItemDetailPage(
                                ...
                                typ: "2",product_id: _con.TimeSubCatItemList[inditem]["kitchen_item_id"].toString(),)
                          )) : Fluttertoast.showToast(msg: "Product not available !!!",
                            toastLength: Toast.LENGTH_SHORT,
                            gravity: ToastGravity.TOP,
                            timeInSecForIosWeb: 35,
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: GestureDetector(
                                                                    onTap: (){
                                                                      ...
                                                                      ["kitchen_item_id"].toString(),"2",quantity.toString(),_con.TimeSubCatItemList[inditem]["kitchen_item_amount"].toString(),
