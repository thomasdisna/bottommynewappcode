...
import 'business_home_kitchen_timeline.dart';
class BusinessLocalShopOrderPage extends StatefulWidget {
  BusinessLocalShopOrderPage({Key key,this.pagid,this.timid,this.memberdate})   : super(key: key);
  String pagid,timid,memberdate;

  @override
  _BusinessLocalShopOrderPageState createState() => _BusinessLocalShopOrderPageState();
}

class _BusinessLocalShopOrderPageState extends StateMVC<BusinessLocalShopOrderPage> {

  HomeKitchenRegistration _con;
  _BusinessLocalShopOrderPageState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
