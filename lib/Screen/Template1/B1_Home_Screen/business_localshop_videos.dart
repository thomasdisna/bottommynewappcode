...
var s = "unlike";
var b = "unmark";
class BusinessLocalShopVideos extends StatefulWidget {

  BusinessLocalShopVideos({this.controo});
  ScrollController controo;

  @override
  _BusinessLocalShopVideosState createState() => _BusinessLocalShopVideosState();
}

class _BusinessLocalShopVideosState extends State<BusinessLocalShopVideos> {
...
//      startAt: Duration(seconds: 10),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFF1E2026),
      body:SingleChildScrollView(controller: widget.controo,
        child: Column(
          children: <Widget>[
            Padding(
