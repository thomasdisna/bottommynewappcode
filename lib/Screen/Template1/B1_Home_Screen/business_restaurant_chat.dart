...
class BusinessRestaurantChatList extends StatefulWidget {
  BusinessRestaurantChatList({this.myID, this.myName,this.timid,this.memberdate,this.pagid});

  String myID;
  String myName,timid,pagid,memberdate;

  @override
  _BusinessRestaurantChatListState createState() => _BusinessRestaurantChatListState();
}

class _BusinessRestaurantChatListState extends StateMVC<BusinessRestaurantChatList> {
  TimelineWallController _con;

  _BusinessRestaurantChatListState() : super(TimelineWallController()) {
    _con = controller;
  }
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RestaurantNewEntryForm(
                              timid: widget.timid,
                              pagid: widget.pagid,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              BusinessRestaurantProductListPage(
                                memberdate: widget.memberdate,
                                pagid: widget.pagid,
                                timid: widget.timid,
                              )));
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => BusinessRestaurantOrderPage(memberdate: widget.memberdate,timid: widget.timid,pagid: widget.pagid,)));
                },
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
