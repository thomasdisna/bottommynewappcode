...
class BusinessRestaurantBlog extends StatefulWidget {

  BusinessRestaurantBlog({this.contro,this.timid});
  ScrollController contro;
  String timid;
  @override
  _BusinessRestaurantBlogState createState() =>
      _BusinessRestaurantBlogState();
}

class _BusinessRestaurantBlogState extends StateMVC<BusinessRestaurantBlog> {

  HomeKitchenRegistration _con;

  _BusinessRestaurantBlogState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
  ...
  @override
  void initState() {
    _con.getBlogListt(widget.timid);
    setState(() { sel=1;});
    super.initState();
  }
  var d;
    ...
    return Scaffold(
        ...
        body:   Column(
          children: [
            ...
            _con.BlogListt.length>0 &&_con.statusBlog == false ?  Expanded(
              child:SmartRefresher(
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: _con.BlogListt.length,
                      itemBuilder: (BuildContext context, int index) {
                        _date = DateTime.parse(
                            _con.BlogListt[index]['created_at']
                            ['date']);
                        _con.BlogListt[index]['like_status'] == true ?
                        _likes[index] = true : _likes[index] = false;
                        _con.BlogListt[index]['save_status'] == true ?
                            ...
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context)=>BlogDetailPage(
                                    video_id: _con.BlogListt[index]["youtube_video_id"],
                                    video_title: _con.BlogListt[index]["youtube_title"],
                                    id: _con.BlogListt[index]["id"].toString(),
                                    blogList: _con.BlogListt,
                                    imageList: _con.BlogListt[index]["post_images"],
                                    title: _con.BlogListt[index]["post_title"],
                                    desc: _con.BlogListt[index]['description'],
                                    date: _con.BlogListt[index]['created_at']['date'].toString(),
                                    views: _con.BlogListt[index]['view_count'].toString(),
                                    comments: _con.BlogListt[index]["comments_count"].toString(),
                                    likes: _con.BlogListt[index]["likes_count"],
                                    shares: _con.BlogListt[index]["share_count"].toString(),
                                    saveStatus: _con.BlogListt[index]["save_status"],
                                    likeStatus: _con.BlogListt[index]["like_status"],
                                    // comments: ,
                                  )
                              ));
                            },
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                          ...
                                          children: [
                                            Text(
                                              _con.BlogListt[index]["post_title"],maxLines: 2,overflow: TextOverflow.ellipsis,
                                              style: f16wB,
                                            ),

                                            Text(_con.BlogListt[index]
                                            ['description'],style: f13w,maxLines: 3,overflow: TextOverflow.ellipsis,),
                                            /*_con.BlogListt[index]
                                            ['description'] !=
                                                "" && _con.BlogListt[index]
                                            ['description'] != null && _con.BlogListt[index]
                                            ['description'].length > 85 && *//*textSpan==false &&*//* _showml[index]==false ?
                                            SmartText(
                                              text:
                                              _con
                                                  .BlogListt[index]['description'].substring(0, 85,) + " .....",
                                              style: f13w,
                                              onOpen:(link){
                                                Navigator.push(context, MaterialPageRoute(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    SizedBox(width: 4,),
                                                    Text(_con.BlogListt[index]['view_count'].toString()+" Views",style: f13b,)
                                                  ],
                                                )
                                              ],
                                            ),
                                      ...
                                      ['post_images']
                                        ...
                                        children: [
                                          ...
                                          userid.toString() == _con.BlogListt[
