...
class LocationAddPage extends StatefulWidget {
  ...
  LocationAddPage({this.long,this.lat,this.location,this.loc_name,this.address});
...
class _LocationAddPageState extends StateMVC<LocationAddPage> {

  TimelineWallController _con;

  _LocationAddPageState() : super(TimelineWallController()) {
    _con = controller;
  }
              ...
              Center(
                child: InkWell(
                  ...
                  onTap: (){
                   ...
                   {
                    _con.addLocationAddress(context,save_name, widget.location, widget.lat, widget.long,
                        _landmark.text, _house_name.text,widget.loc_name);
                   }
                   else{
