...
class BusinessHomeKitchenBlog extends StatefulWidget {

  BusinessHomeKitchenBlog({this.contro,this.timid});
  ScrollController contro;
  String timid;
  @override
  _BusinessHomeKitchenBlogState createState() =>
      _BusinessHomeKitchenBlogState();
}

class _BusinessHomeKitchenBlogState extends StateMVC<BusinessHomeKitchenBlog> {

  HomeKitchenRegistration _con;

  _BusinessHomeKitchenBlogState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                          ...
                                          children: [
                                            Text(
                                              _con.BlogListt[index]["post_title"],
