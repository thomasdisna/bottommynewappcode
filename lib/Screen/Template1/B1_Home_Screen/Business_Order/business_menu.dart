...
class _BusinessHomeKitchenMenuState extends StateMVC<BusinessHomeKitchenMenu> {
  ...
  void initState() {
    ...
    print("KitCatKitCatKitCatKitCatKitCatKitCatKitCatKitCatKitCatKitCatKitCatKitCat"+KitCat.length.toString()+" 6666 "+KitCat.toString());
    setState(() {
      _con.KitchenCategories=KitCat;
      currentind=0;
      sel =1;
      main_currentind=0;
      cat_item= _con.KitchenCategories[0]["name"].toString();
    });
        ...
        return InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(
                builder: (context)=> EachItemDetailPage(typ: "1",product_id:_con.HKProductList[index]["kitchen_item_id"].toString() ,)
            ));
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: CachedNetworkImageProvider("https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F"+
                                          _con.HKProductList[index]["kitchen_item_image"][0]["source"].toString()+ "?alt=media",), fit: BoxFit.cover),
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    Text(
                                        _con.HKProductList[index]["kitchen_item_name"].toString().length>14?_con.HKProductList[index]["kitchen_item_name"].toString().substring(0,14)+"...": _con.HKProductList[index]["kitchen_item_name"].toString(),
                                        style: f15wB
                                    ),
                                    SizedBox(
                                      width: 5,
                                    ),
                                    _con.HKProductList[index]["products_type"].toString() == "1"?Container(
                                      height: 15,
                                      width: 15,
                                      decoration: BoxDecoration(
                                        border:
                                ...
                                Text(
                                  _con.HKProductList[index]["products_category"][0]["category_name"].toString().length>14?_con.HKProductList[index]["products_category"][0]["category_name"].toString().substring(0,14)+"...":_con.HKProductList[index]["products_category"][0]["category_name"].toString(),
                                  style: f14w,
                                ),
                                SizedBox(
                                  height: 3,
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                        _con.HKProductList[index]["kitchen_item_rating"].toString(),
                                        style: f14gB
                                    ),
                                    SizedBox(
                                      width: 2,
                                ...
                                Row(
                                  children: <Widget>[
                                    Text(
                                      "\u20B9  "+_con.HKProductList[index]["kitchen_item_amount"].toString(),
                                      style: f14wB,
                                    ),
                                    Text(
                                      " (Min 5 Pcs)",
          ...
          Container(alignment: Alignment.centerLeft,
            ...
            child: sel==1   ? Column(
              children: [
                ...
                _con.HKProductList.length>0 && _con.statusHKItem==false  ?   Container(height: 115.0,alignment: Alignment.centerLeft,
                    child: ListView.builder(
                      itemCount: _con.HKProductList.length,
                ...
                Container(
                    height: 115.0,
                    child: Center(child: Text("No Items",style: f16wB,))) : Container(),
              ],
            ) :
            sel ==2 ?
                  ...
                  child: Padding(
                    ...
                    child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(_con.KitchenCategories[index]["name"],style: main_currentind==index ? f16B : f16wB,),
                        )),
                  ));
            }
        ),
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                        onTap: () {
                          setState(() {
                            currentind=index;
                            cat_item=_con.TimeSubCat[index]["name"].toString();
                          });
                          _con.BusinessTimelineSubCategoryItemListMenu("1",_con.TimeSubCat[index]["id"].toString(),widget.pagid);
                        ...
                        children: <Widget>[
                          GestureDetector(
                            onTap: () {
                              ...
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context)=>EachItemDetailPage(typ: "1",product_id: _con.TimeSubCatItemList[inditem]["kitchen_item_id"].toString(),)
                              )) : Fluttertoast.showToast(msg: "Product not available !!!",
                                toastLength: Toast.LENGTH_SHORT,
                                gravity: ToastGravity.TOP,
                                timeInSecForIosWeb: 35,
                                          ...
                                          children: <Widget>[
                                            Row(
                                              children: <Widget>[
                                                ...
                                                GestureDetector(
                                                  onTap:(){
                                                    _con.AddtoPurchaseList(userid.toString(), _con.TimeSubCatItemList[inditem]
