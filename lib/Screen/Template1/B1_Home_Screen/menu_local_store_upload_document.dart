...
class LocalbusinessUpload extends StatefulWidget {
  LocalbusinessUpload({this.pagid, this.timid,this.name,this.indexx,this.place,this.username});

  String pagid, timid,name,username,place;
  int indexx;

  @override
  _LocalbusinessUploadState createState() => _LocalbusinessUploadState();
}



class _LocalbusinessUploadState extends StateMVC<LocalbusinessUpload> {

  String prof_img;
  Validations validations = new Validations();
  HomeKitchenRegistration _con;

  _LocalbusinessUploadState() : super(HomeKitchenRegistration()) {
    _con = controller;
  }
...
class ImageUploadProgress extends StatefulWidget {
  ...
  ImageUploadProgress({this.accnum,this.accname,this.branchh,this.fssaiimg,
    ...
    this.index,this.name,this.username,this.place,this.bankname});

  String panimg,fssaiimg,proimg,accname,accnum,ifsccc,branchh,pagee,timm,busname,name,username,place,bankname;
  int index;
  @override
...
class _ImageUploadProgressState extends StateMVC<ImageUploadProgress> {
  ...
  _setval(){
    _con.LocalStoDocumentUpload(context,widget.panimg,
        widget.fssaiimg, "2", widget.pagee, widget.timm,widget.accname,widget.accnum,
