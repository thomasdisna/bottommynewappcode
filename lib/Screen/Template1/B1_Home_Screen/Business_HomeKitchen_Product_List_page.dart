...
class BusinessHomeKitchenProductListPage extends StatefulWidget {
  String pageid, timeid, memberdate;

  BusinessHomeKitchenProductListPage(
      {this.pageid, this.timeid, this.memberdate});

  @override
  _BusinessHomeKitchenProductListPageState createState() =>
      _BusinessHomeKitchenProductListPageState();
}

class _BusinessHomeKitchenProductListPageState
    extends StateMVC<BusinessHomeKitchenProductListPage> {
  HomeKitchenRegistration _con;

  _BusinessHomeKitchenProductListPageState()
      : super(HomeKitchenRegistration()) {
    _con = controller;
  }

  @override
  void initState() {
    print(" ufhbobohipsdvn "+widget.pageid+" "+widget.timeid);
    _con.HomeKitchenProductList("1", widget.pageid, widget.timeid);
  ...
  void toggleActivateAll(bool value) {
    if (switchControlAll == false) {
      _con.KitchenActiveAllStatus(widget.pageid, widget.timeid);
      setState(() {
  ...
  void searchOperation(String searchText) {
    ...
    _con.HKProductList.forEach((userDetail) {
                        ...
                        child: Column(
                          children: <Widget>[
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  BusinessHomeKitchenAddItemPage(
                                                    pagid: widget.pageid,
                                                    timid: widget.timeid,
                                                    memberdate: widget.memberdate,
                                                  )));
                                      _con.HomeKitchenProductList(
                                          "1", widget.pageid, widget.timeid);
                                    },
                                    child: Container(
                                      height: 60,
                                      width:
                            ...
                            Padding(
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      ItemDetailPage(tabb: 1,
                                                        member: widget.memberdate,typ: "1",timid: widget.timeid,
                              ...
                              Container(
                                height:
                                    _con.HKProductList.length.toDouble() * 140,
                                child:  ListView.builder(
                                    physics: NeverScrollableScrollPhysics(),
                                    reverse: true,
                                    ...
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      _con.HKProductList[index]['products_status']
                                                  .toString() ==
                                              "0"
                                          ? _active[index] = true
                                          : _active[index] = false;
                                      _con.HKProductList[index]['placeorder_type']
                                          .toString() ==
                                          "0"
                                          ? _buynow[index] = false
                                          : _buynow[index] = true;
                                                      ...
                                                      child: Row(
                                                        children: <Widget>[
                                                          ...
                                                          Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                                border: Border.all(
                                                                    color: _con.HKProductList[index]['products_type']
                                                                                .toString() ==
                                                                            "1"
                                                                        ? Colors.red[
                                                                            700]
                                                                        ...
                                                                        children: <
                                                                          ...
                                                                          Container(clipBehavior: Clip.antiAlias,
                                                                            ...
                                                                            child:
                                                                                CachedNetworkImage(
                                                                              imageUrl: "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/thumbs%2F" +
                                                                                  _con.HKProductList[index]['kitchen_item_image'][0]["source"].toString() +
                                                                                  "?alt=media",
                                                                              fit:
                                                                                  BoxFit.cover,
                                                                              placeholder: (context, ind) =>
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: <
                                                                                Widget>[
                                                                              Text(
                                                                               "In "+ _con.HKProductList[index]['products_category'][0]["parent_category_name"],
                                                                                style: f14w,
                                                                              ),
                                                                              SizedBox(height: 3),
                                                                              Text(
                                                                                "In "+_con.HKProductList[index]['products_category'][0]["category_name"],
                                                                                style: f14w,
                                                                              ),
                                                                              SizedBox(height: 3),
                                                                              Row(
                                                                                children: <Widget>[
                                                                                  ...
                                                                                  Text(_con.HKProductList[index]['kitchen_item_rating'].toString(), style: f14gB),
                                                                                  Text(" Ratings", style: f14g)
                                                                                ],
                                                                              ),
                                                                              ...
                                                                              Row(
                                                                                children: <Widget>[
                                                                                  Text("Price: ", style: f14w),
                                                                                  Text("\u20B9 " + _con.HKProductList[index]['kitchen_item_amount'].toString(), style: f14wB),
                                                                                ],
                                                                              ),
                                                                            ],
                                                                          ),
                                                                          ...
                                                                          if (_active[index] ==
                                                                            ...
                                                                            setState(
                                                                              ...
                                                                              _con.HKACTIVE =
                                                                                  _con.HKACTIVE + 1;
                                                                              _con.HomeKitchenUpdateActiveStatus(
                                                                                  _con.HKProductList[index]['kitchen_item_id'].toString(),
                                                                                  "1",
                                                                                  widget.pageid);
                                                                            });
                                                                          else
