...
class BusinessHomeKitchenAddItemPage extends StatefulWidget {
  ...
  @override
  _BusinessHomeKitchenAddItemPageState createState() => _BusinessHomeKitchenAddItemPageState();
}

class _BusinessHomeKitchenAddItemPageState extends StateMVC<BusinessHomeKitchenAddItemPage> {
  File imageFile;
  ...
  _SubCatimagUpload() {
    ...
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (context) =>
                bottomNavBarHomeKitchen(memberdate: widget.memberdate,pagid: widget.pagid,timid: widget.timid,currentIndex: 3,upld: false,)));
  ...
  _imagUpload() {
    ...
    _con.HomeKitchenAddItem(context,"22",IMAGELIST.join(",").toString(),subCatg,"image",_displayName.text,product_cost.toString(),subCatg,hot_deal?"1":"0",switchControlBuyPre?"1":0,"1",subcategid.toString(),
        "business","1",quantity_value.toString(),servicecharge.toString(),_earnings.text,distance_value.toString(),widget.pagid,widget.timid,widget.memberdate,"","","","","");
    IMAGELIST = [];
    imageList = [];
    return Container();
  }
  ...
  Future<Null> _selectTime1(BuildContext context) async {
    ...
    if (picked != null)
      setState(() {
        ...
        _time1 = selectedTime.toString().replaceAll("TimeOfDay(", "").replaceAll(")", "");
      });
  }
  ...
  Future<Null> _selectTime2(BuildContext context) async {
    ...
    if (picked != null)
      setState(() {
        var selectedTime = picked;
        _time2 = selectedTime.toString().replaceAll("TimeOfDay(", "").replaceAll(")", "");
      });
  }
                ...
                children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: CachedNetworkImageProvider(subCatImg.length==16 || subCatImg.length==24 ? "https://firebasestorage.googleapis.com/v0/b/foodizwall.appspot.com/o/"+subCatImg+"?alt=media" :
                                    subCatImg),
                                    fit: BoxFit.cover),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Row(crossAxisAlignment: CrossAxisAlignment.center,
                        children: <Widget>[
                          Text("Self Delivery\nDistance",style: f14wB,textAlign: TextAlign.center,),
                          SizedBox(width: 10,),
                          Container(height: 30,width: 90,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(5),
                  ...
                  SizedBox(height: 10,),
                  Text("Items will be active after Approval in 24 hrs in item list.",style: f14w,),
                  SizedBox(height: 2,)
                ],
              ) : Container(height: 0,),
            ],
